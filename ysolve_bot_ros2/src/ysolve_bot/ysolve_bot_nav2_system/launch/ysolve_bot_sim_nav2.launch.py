...
def generate_launch_description():
    ...
    project_dir = get_package_share_directory('ysolve_bot_nav2_system')
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(project_dir, 'config', 'ysolve_bot_map.yaml'),
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world',
        default_value= os.path.join(get_package_share_directory('ysolve_bot_world'),'world/burger.model'),
